= Enable ssmtp recipe (this step should not have to be repeated after initial setup)
...
1. Ensure ssmtp recipes in cookbooks/main/recipes/default.rb aren't commented out: require_recipe "ssmtp"
