...
portage_files = [
  ...
  "/etc/portage/package.keywords/php56keywords",
  "/etc/portage/package.unmask/php56unmask",
  "/etc/portage/package.use/php56use"
]
...
extension_files = [
  "/etc/php/cgi-php5.6/ext/redis.ini",
  "/etc/php/cli-php5.6/ext/redis.ini",
  "/etc/php/fpm-php5.6/ext/redis.ini",
  "/etc/php/cgi-php5.6/ext/mongo.ini",
  "/etc/php/cli-php5.6/ext/mongo.ini",
  "/etc/php/fpm-php5.6/ext/mongo.ini",
  "/etc/php/cgi-php5.6/ext/memcache.ini",
  "/etc/php/cli-php5.6/ext/memcache.ini",
  "/etc/php/fpm-php5.6/ext/memcache.ini"
]
...
execute "install php module redis" do
  command "pecl install -f redis-2.2.8"
end
